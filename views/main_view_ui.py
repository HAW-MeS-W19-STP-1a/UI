...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dateTimeEdit_start.setMinimumSize(QtCore.QSize(115, 0))
        ...
        self.dateTimeEdit_stop.setMinimumSize(QtCore.QSize(115, 0))
        ...
        self.MplWidget = MplWidget(self.verticalWidget_Graph)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.action_set_update_interval_15_sec = QtWidgets.QAction(MainWindow)
        self.action_set_update_interval_15_sec.setCheckable(True)
        self.action_set_update_interval_15_sec.setObjectName("action_set_update_interval_15_sec")
        ...
        self.action_set_view_last_1_minute = QtWidgets.QAction(MainWindow)
        self.action_set_view_last_1_minute.setCheckable(True)
        self.action_set_view_last_1_minute.setObjectName("action_set_view_last_1_minute")
        self.action_set_view_last_15_minute = QtWidgets.QAction(MainWindow)
        self.action_set_view_last_15_minute.setCheckable(True)
        self.action_set_view_last_15_minute.setObjectName("action_set_view_last_15_minute")
        self.action_set_view_last_1_h = QtWidgets.QAction(MainWindow)
        self.action_set_view_last_1_h.setCheckable(True)
        self.action_set_view_last_1_h.setObjectName("action_set_view_last_1_h")
        self.action_set_view_last_1_d = QtWidgets.QAction(MainWindow)
        self.action_set_view_last_1_d.setCheckable(True)
        self.action_set_view_last_1_d.setObjectName("action_set_view_last_1_d")
        self.action_set_view_last_1_w = QtWidgets.QAction(MainWindow)
        self.action_set_view_last_1_w.setCheckable(True)
        self.action_set_view_last_1_w.setObjectName("action_set_view_last_1_w")
        self.action_set_view_last_1_m = QtWidgets.QAction(MainWindow)
        self.action_set_view_last_1_m.setCheckable(True)
        self.action_set_view_last_1_m.setObjectName("action_set_view_last_1_m")
        ...
        self.menuSet_Update_Intervall.addAction(self.action_set_update_interval_15_sec)
        ...
        self.menuView.addAction(self.action_set_view_last_1_minute)
        self.menuView.addAction(self.action_set_view_last_15_minute)
        self.menuView.addAction(self.action_set_view_last_1_h)
        self.menuView.addAction(self.action_set_view_last_1_d)
        self.menuView.addAction(self.action_set_view_last_1_w)
        self.menuView.addAction(self.action_set_view_last_1_m)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_set_update_interval_15_sec.setText(_translate("MainWindow", "1 min"))
        ...
        self.action_set_view_last_1_minute.setText(_translate("MainWindow", "Last Minute"))
        self.action_set_view_last_15_minute.setText(_translate("MainWindow", "Last 15 Minutes"))
        self.action_set_view_last_1_h.setText(_translate("MainWindow", "Last Hour"))
        self.action_set_view_last_1_d.setText(_translate("MainWindow", "Last Day"))
        self.action_set_view_last_1_w.setText(_translate("MainWindow", "Last Week"))
        self.action_set_view_last_1_m.setText(_translate("MainWindow", "Last Month"))
